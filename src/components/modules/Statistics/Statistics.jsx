...
export const Statistics = () => {
    return(
        <Container pb={100} pt={46}>
            <StatisticsList>
                <StatistItem src={statistics1} number = '98.5 %' text = 'Позитивних відгуків'/>
                <StatistItem src={statistics2} number = '+ 54' text = 'Проведених навчань'/>
                <StatistItem src={statistics3} number = '+ 1658' text = 'Задоволених клієнтів'/>
